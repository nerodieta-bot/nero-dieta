...
import { AlertCircle, Link as LinkIcon, Home, PawPrint, ChevronDown } from 'lucide-react';
...
const statusVariantMap: Record<IngredientStatus, Record<string, string>> = {
  safe: {
    card: 'bg-[#e9f9ed] border-green-200 dark:bg-card',
    title: 'text-green-800 dark:text-green-300',
    description: 'text-green-700 dark:text-green-400',
    badge: 'bg-green-600 text-white',
    warningBox: 'border-emerald-300 bg-[#f0fff4] dark:bg-card',
    detailsBox: 'border-[#b7e2c2] bg-[#f4fbf5] dark:bg-card',
  ...
  warning: {
    card: 'bg-[#fff5e5] border-amber-200 dark:bg-card',
    title: 'text-amber-800 dark:text-amber-300',
    description: 'text-amber-700 dark:text-amber-400',
    badge: 'bg-amber-500 text-amber-950',
    warningBox: 'border-amber-400 bg-[#fff7ed] dark:bg-card',
    detailsBox: 'border-[#fbd38d] bg-[#fff9f0] dark:bg-card',
  ...
  danger: {
    card: 'bg-[#ffecec] border-red-200 dark:bg-card',
    title: 'text-red-800 dark:text-red-300',
    description: 'text-red-700 dark:text-red-400',
    badge: 'bg-red-600 text-white',
    warningBox: 'border-red-400 bg-[#fff2f2] dark:bg-card',
    detailsBox: 'border-[#fecaca] bg-[#fff6f6] dark:bg-card',
        ...
        <Collapsible defaultOpen className="w-full">
            <Card className={cn(
                ...
                <CollapsibleTrigger className="w-full text-left">
                    <CardHeader className="text-center items-center p-4 md:p-6 relative group">
                        ...
                        <ChevronDown className="absolute bottom-4 right-4 h-6 w-6 text-muted-foreground transition-transform duration-300 group-data-[state=open]:rotate-180" />
                    </CardHeader>
                </CollapsibleTrigger>
